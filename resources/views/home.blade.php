...
@section('content')
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 text-center">
        <h1>What is Data Warrior?</h1>

        <h4><small>
                A DataWarrior seeks to use data &amp; information technology (IT) for
                a better career. He counters the anxiety that students and
                professionals face by being more informed and skilled at his chosen
                technology through learning and the sharing of ideas. The
                DataWarrior knows that every professional challenge can be
                overcome through knowledge, training and wisdom…come…join
                us…be a DataWarrior!</small></h4>
    </div>
