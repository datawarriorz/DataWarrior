...
<div class="internship-container">
    <div id="regForm">
        <form class="" method="POST" action="/jobform">
            <div id="tab1">
                <h2>New User?</h2>
                <h2>Click 'Next' To Fill Job Application Details</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name='skill1' required class="form-control" placeholder="Eg. Asp.Net"
                                autocomplete="on" value={{old('skill1')}}>
                        </div>
                        <div class="form-group">
                            <label for="skill2">Skill 2 :</label>
                            <input type="text" name='skill2' required class="form-control" placeholder="Eg. PHP"
                                value={{old('skill2')}}>
                        </div>
                        <div class="form-group">
                            <label for="skill3">Skill 3 :</label>
                            <input type="text" name='skill3' class="form-control" placeholder="Eg. SQL"
                                value={{old('skill3')}}>
                        </div>
                        <p>
