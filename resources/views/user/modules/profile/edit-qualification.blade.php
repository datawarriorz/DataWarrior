                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name='percentage' class="form-control col-md-12"
                                    placeholder="Eg. 70.08" autocomplete="on"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" placeholder="Click here to Select Date." name="start_date"
                                    autocomplete="on" onfocus="(this.type='date')" required
                                    class="form-control col-md-12" value={{ old('start_date') }}>
                            </div>
                            <br>
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" placeholder="Click here to Select Date." name="end_date"
                                    autocomplete="on" onfocus="(this.type='date')" required
                                    class="form-control col-md-12" value={{ old('end_date') }}>
                            </div>
                        </div>
