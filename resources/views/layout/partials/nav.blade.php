...
<div class="navbar-container">
  <nav class="navbar navbar-expand-lg">
      <a class="navbar-brand"  href="#"><img class="navbar-brand-img" alt="Logo"
              class="nav-img" src="./images/logo.png" /></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-right justify-content-end">
            @guest  
            <li class="nav-item">
                  <a class="nav-link-right" href="{{ route('login') }}"><button type="button" class="btn navbtn">LOGIN</button></a>
            </li>
